...
import org.usfirst.frc.team5003.robot.commands.RunControllerWithPowerCommand;
import edu.wpi.first.wpilibj.buttons.JoystickButton;
import edu.wpi.first.wpilibj.smartdashboard.SmartDashboard;

public class OI {
	
	public JoystickButton btnGrabberOpen, btnGrabberClose, btnActuatorUp, btnActuatorDown, btnGearOut, btnGearIn;
	...
	public OI() {
		...
		if (Robot.gearController.isGood) {
			...
			btnGearIn.whileHeld(new RunControllerWithPowerCommand(Robot.gearController, "Gear Power", +1));
			btnGearOut.whileHeld(new RunControllerWithPowerCommand(Robot.gearController, "Gear Power", -1));
		}
...
//			SmartDashboard.putData("Drive", new DriveWithDurationAndPowerCommand("Duration", "Power"));
//		}
//		
